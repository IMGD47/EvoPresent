...
def chunk_text_chinesev2(text, limit=60, look_ahead_limit=30):
    """
    Split Chinese text into chunks, prioritizing chunks ending with period, exclamation or question marks,
    then considering commas and other punctuation, avoiding breaks without punctuation
    
    Args:
        text: Text to split
        limit: Chinese character limit per chunk
        look_ahead_limit: Maximum characters to look ahead
