...
'''
Based on HiFiGAN (https://arxiv.org/pdf/2010.05646.pdf) v2 structure
Multi-scale with different kernel_size, 3 parallel convolution modules, each with different serial dilation sizes and interleaved normal non-dilation convolution layers
'''
