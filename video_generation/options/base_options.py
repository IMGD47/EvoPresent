...
class BaseOptions():
	...
	def initialize(self, parser):
		...
		_checkpoints_dir = os.path.join(_base_dir, 'checkpoints')
		
		parser.add_argument('--pretrained_dir', type=str, default=_checkpoints_dir)
		...
		parser.add_argument('--wav2vec_model_path', default=os.path.join(_checkpoints_dir, 'wav2vec2-base-960h'))
		parser.add_argument('--audio2emotion_path', default=os.path.join(_checkpoints_dir, 'wav2vec-english-speech-emotion-recognition'))
